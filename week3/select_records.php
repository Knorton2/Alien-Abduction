<?php include("includes/header.php"); ?>							           <!--includes the functional links and header-->
<?php include("includes/navigation.php");  				 		           //includes navigation file
?>
	...
	dbconn();					//select a database on this connection (there is only one) - different method from another page!!! (deliberate)
	...
	if(!$result = mysqli_query($connection, $sql))					//run the query on this connection/database and test if OK
	...
	dbdisconn();										//don't forget to tidy up & close the dbase conection
?>
	...
	<?php include("includes/footer.php"); 							//includes the footer html
?>
